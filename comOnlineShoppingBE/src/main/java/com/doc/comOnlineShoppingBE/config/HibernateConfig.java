package com.doc.comOnlineShoppingBE.config;
...
@Configuration
@ComponentScan(basePackages={"com.doc.comOnlineShoppingBE.dto"})
...
public class HibernateConfig {
	...
	public SessionFactory getSessionFactory(DataSource dataSource) {
		...
		builder.scanPackages("com.doc.comOnlineShoppingBE.dto");
